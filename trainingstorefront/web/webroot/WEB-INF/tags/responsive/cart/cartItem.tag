...
<c:if test="${not empty entry}">
        ...
        <li class="item__list--item">
           ...
           <%--manufacturer details--%>
                <div class="item_manufacturerInfo">
                    <c:forEach items="${entry.product.manufacturerInfo}" var="manufacturer">
                       Id: ${manufacturer.id}<br>
                       Name: ${manufacturer.name}<br>
                        Year${manufacturer.establishmentYear}
                    </c:forEach>
                </div>
            ...
            <div class="item__delivery">
                ...
                <%--duplicate--%>
                <div class="item_duplicate">
                    <a href="https://powertools.local:9002/trainingstorefront/powertools/en/USD/cart/entry/duplicate/${entry.entryNumber}"/>Duplicate</a>
                </div>
